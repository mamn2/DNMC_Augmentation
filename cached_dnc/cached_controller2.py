...
import recurrent_controller2
import feedforward_controller2

class CachedFWController(feedforward_controller2.FeedforwardController):
...
class CachedLSTMController(recurrent_controller2.StatelessRecurrentController):
